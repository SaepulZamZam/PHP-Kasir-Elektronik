            ...
            <div class="table-responsive-md my-3">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><label for="nama">Nama Elektronik</label></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="deskripsi" id="deskripsi" value= "<?= $menu["deskripsi"]; ?>" required></td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="kategori" id="kategori">
                                ...
                                <option value="Laptop" <?= $menu["kategori"] == "Laptop" ? "selected" : ""; ?>>Laptop</option>

                                <option value="HandPhone" <?= $menu["kategori"] == "HandPhone" ? "selected" : ""; ?>>HandPhone</option>

                                <option value="Headset" <?= $menu["kategori"] == "Headset" ? "selected" : ""; ?>>Headset</option>

                                <option value="Kulkas" <?= $menu["kategori"] == "Kulkas" ? "selected" : ""; ?>>Kulkas</option>

                                <option value="Television" <?= $menu["kategori"] == "Television" ? "selected" : ""; ?>>Television</option>

                                <option value="Washing Machine" <?= $menu["kategori"] == "Washing Machine" ? "selected" : ""; ?>>Washing Machine</option>

                                <option value="AC" <?= $menu["kategori"] == "AC" ? "selected" : ""; ?>>AC</option>

                                <option value="Printer" <?= $menu["kategori"] == "Printer" ? "selected" : ""; ?>>Printer</option>
